...
type Step = 'welcome' | 'agent' | 'complete';
          ...
          {currentStep === 'welcome' && (
            <div className="text-center">
              ...
              <p className="text-neutral-400 mb-8 max-w-md mx-auto">
                Connect your first backend agent to get started. You can configure
                AI providers and other settings later from the Settings page.
              </p>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-neutral-500 mt-2">
                    Format: http://host:port (e.g. http://agent-1:8090)
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="Enter the agent's AGENT_TOKEN"
                  ...
                  <p className="text-xs text-neutral-500 mt-2">
                    The token configured on the backend via <code className="text-[#00fff2]">AGENT_TOKEN</code>.
                  </p>
                </div>
              ...
              <div className="flex justify-between mt-8">
                ...
                <button
                  ...
                  disabled={!agentName.trim() || !agentUrl.trim() || !agentToken.trim() || saving}
