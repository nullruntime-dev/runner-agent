...
export default async function ExecutionPage({ params }: PageProps) {
  ...
  return (
    <main className="h-screen flex flex-col bg-neutral-950">
      {/* Top navigation */}
      <header className="bg-neutral-900 border-b border-neutral-800 flex-shrink-0">
        <div className="h-12 px-4 flex items-center gap-4">
          ...
          <div className="h-4 w-px bg-neutral-800" />
          <span className="text-xs text-neutral-600 uppercase tracking-wider">Execution</span>
        </div>
      </header>
